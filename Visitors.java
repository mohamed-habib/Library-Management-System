 ...
 * Visitors.java 
 * 
 * A child of @Screen that handles the visitors of the system. Can add, edit, view, delete visitors of the system,
 * 
...
public class Visitors extends Screen {
	...
	public Visitors() {
		...
		super("Visitors", new String[] { "ID:", "Name:", "SNN:", "Faculty:",
				"Class:" }, 5);
